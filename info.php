    ...
    <nav class="bg-white shadow">
            ...
            <div class="flex h-16 justify-between">
                <div class="flex px-2 lg:px-0">
                    <div class="hidden lg:ml-6 lg:flex lg:space-x-8">
                        ...
                        <a href="info.php" class="inline-flex items-center border-b-2 border-indigo-500 px-1 pt-1 text-sm font-medium text-gray-900">Informatie</a>
        ...
        <div class="lg:hidden" id="mobile-menu">
            <div class="space-y-1 pb-3 pt-2">
                ...
                <a href="info.php" class="block border-l-4 border-indigo-500 bg-indigo-50 py-2 pl-3 pr-4 text-base font-medium text-indigo-700">Informatie</a>
                ...
                <a href="test.php" class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-600 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800">Blog</a>
            </div>
        </div>
    </nav>
    <div class="bg-white">
        <main class="isolate">
                    ...
                    <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                        <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                            <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Wat is Prikkelbare Darm Syndroom (PDS)</h1>
                                <p class="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                                    <span class="font-bold">Prikkelbare Darm Syndroom (PDS)</span> is een chronische darmaandoening waarbij je vooral buikpijn en
                                    ontlastingsproblemen (bijvoorbeeld verstopping of diarree) hebt. Ook gasvorming, een opgezette
                                    buik en vermoeidheid komen veel voor.
                                </p>
                ...
                <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                    <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                        <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
                            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Aantal gevallen</h2>
                            <p class="mt-5 max-w-xl text-base leading-7 text-gray-700">
                                Naar schatting heeft 5 - 20 % van de Nederlandse bevolking last van PDS.
                                Bij vrouwen komt de aandoening twee keer zo vaak voor als bij mannen.
                                De precieze oorzaak van PDS is niet bekend, maar meestal is er sprake
                                van een overgevoelige darmwand en/of van verstoorde (spastische) bewegingen van de darm.</p>

                        </div>
                        <div class="lg:flex lg:flex-auto lg:justify-center">
                            <dl class="w-64 space-y-8 xl:w-80">
                                <div class="flex flex-col-reverse gap-y-4">
                                    <dt class="text-base leading-7 text-gray-600">gevallen in Nederland</dt>
                                    <dd class="text-5xl font-semibold tracking-tight text-gray-900">5-20%</dd>
                                </div>
                                <div class="flex flex-col-reverse gap-y-4">
                                    <dt class="text-base leading-7 text-gray-600">gevallen in de wereld</dt>
                                    <dd class="text-5xl font-semibold tracking-tight text-gray-900">1 op de 10</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0">
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Symptomen</h2>
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        PDS-klachten verschillen van persoon tot persoon.
                        Zelfs bij één persoon kunnen de klachten van dag tot dag verschillen.
                        Perioden met en zonder klachten kunnen elkaar ook afwisselen.</p>
                </div>
                <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    <div>
                        <dt class="font-semibold text-gray-900">Buikpijn</dt>
                        <dd class="mt-1 text-gray-600">
                            Het meest kenmerkende symptoom van Prikkelbare Darm Syndroom is zeurende,
                            krampende of stekende pijn in de buik. Deze kan zeer hevig zijn, maar kan ook licht zijn.
                            Dat is heel verschillend per persoon en per dag. De buikpijn vermindert of verergert soms na de
                            stoelgang of het laten van een wind.</dd>
                    </div>
                    <div>
                        <dt class="font-semibold text-gray-900">Verstopping en/of diarree</dt>
                        <dd class="mt-1 text-gray-600">
                            PDS gaat gepaard met een afwijkend ontlastingspatroon. Een deel van de
                            PDS-patiënten heeft met name last van verstopping, anderen hebben vooral last van diarree.
                            Een ontlastingspatroon waarbij verstopping en diarree elkaar afwisselen komt ook vaak voor.
                            Het ontlastingspatroon kan gedurende de dag wijzigen. Plotselinge, onhoudbare aandrang komt veel voor.</dd>
                    </div>
                    <div>
                        <dt class="font-semibold text-gray-900">Gasvorming en vermoeidheid</dt>
                        <dd class="mt-1 text-gray-600">
                            Hiernaast hebben PDS-patiënten vaak andere maag-darmklachten. Veel voorkomend
                            zijn gasvorming, winderigheid, een opgeblazen gevoel en een opgezette buik.
                            Daarnaast is vermoeidheid ook een PDS-symptoom.</dd>
                    </div>
                    <div>
                        <dt class="font-semibold text-gray-900">Geen PDS-symptomen</dt>
                        <dd class="mt-1 text-gray-600">
                            PDS-patiënten hebben vaak ook heel andere klachten, die niet onder de PDS-symptomen vallen.
                            Voorbeelden hiervan zijn zuurbranden, slikklachten, een brok in de keel, misselijkheid,
                            spierpijn, rugpijn, hoofdpijn, problemen met plassen, onregelmatige menstruatie en pijn
                            tijdens of na de seksuele gemeenschap. Niet alle PDS-patiënten hebben hier last van.</dd>
                    </div>
                    <div>
                        <dt class="font-semibold text-gray-900">Mogelijke symptomen</dt>
                        <dd class="mt-1 text-gray-600">MOGELIJKE SYMPTOMEN</dd>
                    </div>
                    <div>
                        <dt class="font-semibold text-gray-900">Mogelijke symptomen</dt>
                        <dd class="mt-1 text-gray-600">MOGELIJKE SYMPTOMEN</dd>
            ...
            <div class="relative isolate -z-10 mt-32 sm:mt-48">
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <h2 class="text-center text-lg font-semibold leading-8 text-gray-900">Een samenwerking van de Hanzehogeschool en Noorderpoort</h2>
                    <div class="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <img class="col-span-2 max-h-14 w-full object-contain lg:col-span-1" src="images/HanzeLogo.png" alt="Transistor" width="158" height="48">
                        <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" src="images/Noorderpoort.png" alt="Reform" width="158" height="48">
                    </div>
                </div>
            </div>
