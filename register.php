            ...
            <div class="flex h-16 justify-between">
                ...
                <div class="flex px-2 lg:px-0">
                    <div class="hidden lg:ml-6 lg:flex lg:space-x-8">
                        ...
                        <a href="register.php" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-indigo-500 hover:text-gray-700">Registreren</a>
                    </div>
                </div>
            </div>
        </div>
